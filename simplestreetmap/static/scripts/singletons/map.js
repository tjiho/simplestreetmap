import {
  render,
  html,
} from "../../../static/vendor/preact/standalone.module.js";
  ...
  onClick(e) {
    ...
    render(
      html`<${ContextMenu}
        ...
        currentPopup=${popup}
        canEdit=${websocketClient.canEdit}
        local=${websocketClient.isLocal}
      />`,
      tooltipNode,
    );

    popup.setLngLat(e.lngLat).setDOMContent(tooltipNode).addTo(this.getMap());
  }
